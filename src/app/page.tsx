  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-wood-100 via-wood-50 to-wood-50">
      ...
      <section className="relative mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 sm:py-24">
        ...
        <h1 className="font-display text-3xl leading-tight text-wood-900 sm:text-4xl md:text-5xl">
          A Place for the Moebius to get to know each other, to connect,
          <br className="hidden sm:inline" /> and to create our meaningful work together.
        </h1>
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            href="/register"
            className="w-full rounded-full bg-sage-600 px-8 py-3 text-white hover:bg-sage-700 transition-colors sm:w-auto"
          >
            Join the family
          </Link>
          <Link
            href="/members"
            className="w-full rounded-full border border-wood-300 px-8 py-3 text-wood-800 hover:bg-wood-100 transition-colors sm:w-auto"
          >
            Browse members
          </Link>
        </div>
      ...
      <section className="relative mx-auto max-w-4xl px-4 py-14 sm:px-6 sm:py-20">
